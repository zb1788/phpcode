package com {
	...
	public class LunboIMG extends MovieClip{
		...
		public function LunboIMG(arr:Array,_imgnum:int = 0) {
		...
		var xuanzezhuagntai:XuanZeState = new XuanZeState();
		// 移除容器所有图像 并添加新图像
		private function createBit(b:Bitmap):void{
			...
			xuanzezhuagntai.GlowFilterExample(bit);
			imgMc.addChild(bit);
